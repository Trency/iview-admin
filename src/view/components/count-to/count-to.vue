  ...
  <div>
    <Row :gutter="14">
      <i-col span="3">
        <Card>
          <p slot="title">
            <Icon type="waterdrop"></Icon>count-to组件基础用法
          </p>
      ...
      <i-col span="8" class="padding-left-10">
        <Card>
          <p slot="title">
            <Icon type="paintbucket"></Icon>自定义样式
          </p>
          <Row type="flex" justify="center" align="middle" class="countto-page-row">
            <div class="count-to-con">
      ...
      <i-col span="8" class="padding-left-10">
        <Card>
          <p slot="title">
            <Icon type="settings"></Icon>设置数据格式
          </p>
          <Row type="flex" justify="center" align="middle" class="countto-page-row">
            <div class="count-to-con">
    ...
    <Row :gutter="14" style="margin-top: 14px;">
      ...
      <i-col span="8" class="padding-left-10">
        <Card>
          <p slot="title">
            <Icon type="ios-shuffle-strong"></Icon>自定义单位
          </p>
          <Row type="flex" justify="center" align="middle" class="countto-page-row">
            <div class="count-to-con">
              <count-to
    ...
    <Row :gutter="14" style="margin-top: 14px;">
      <i-col>
        <Card>
          <p slot="title">
            <Icon type="ios-analytics"></Icon>综合实例
          </p>
          <Row type="flex" justify="center" align="middle" class="countto-page-row">
            <div class="count-to-con">
              <count-to
